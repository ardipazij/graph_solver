...
<ul>
    <li><b>Загрузка и сохранение графа:</b>
        <ul>
            <li>Загрузить граф из файла - загружает граф из текстового файла</li>
            <li>Сохранить текущий граф в файл - сохраняет текущий граф в текстовый файл</li>
        </ul>
    </li>
    <li><b>Создание графа:</b>
        <ul>
            <li>Добавление вершин - клик по свободной области графа</li>
            <li>Добавление рёбер - перетаскивание от одной вершины к другой</li>
            <li>Ввод матрицы смежности - для создания графа из матрицы</li>
            <li>Ввод матрицы инцидентности - для создания графа из матрицы</li>
            <li>Генерация случайного графа - создание графа с заданными параметрами</li>
        </ul>
    </li>
    <li><b>Настройки графа:</b>
        <ul>
            <li>Ориентированный/неориентированный - переключение типа графа</li>
            <li>Взвешенный/невзвешенный - переключение типа рёбер</li>
            <li>Размещение вершин - выбор алгоритма размещения вершин на плоскости</li>
        </ul>
    </li>
    <li><b>Алгоритмы:</b>
        <ul>
            <li>BFS (поиск в ширину) - обход графа в ширину</li>
            <li>DFS (поиск в глубину) - обход графа в глубину</li>
            <li>Дейкстра - поиск кратчайшего пути</li>
            <li>Беллман-Форд - поиск кратчайшего пути с отрицательными весами</li>
            <li>MaxPath - поиск максимального пути</li>
            <li>Kruskal - построение минимального остовного дерева</li>
            <li>Prim - построение минимального остовного дерева</li>
        </ul>
    </li>
</ul>
...
<ul>
    ...
    <li><b>Пауза/Продолжить:</b> кнопка ⏸/▶ для управления анимацией</li>
    <li><b>Пошаговое выполнение:</b> кнопки ⏮ (начало) и ⏭ (следующий шаг)</li>
</ul>
...
<ul>
    <li><b>Матрица смежности:</b>
        <ul>
            ...
            <li>Элементы: 0 (нет связи) и 1 или вес (есть связь)</li>
        </ul>
    </li>
...
<ul>
    <li><b>Псевдокод:</b> отображение текущего шага алгоритма</li>
    <li><b>Состояние переменных:</b> отображение текущих значений переменных алгоритма</li>
    <li><b>Пояснения:</b> подробное описание каждого шага алгоритма</li>
    <li><b>Логирование:</b> запись всех действий алгоритма</li>
</ul>

<h3>Горячие клавиши:</h3>
<ul>
    <li>Ctrl+Z - отмена последнего действия</li>
    <li>Ctrl+Y - повтор последнего действия</li>
    <li>Ctrl+S - сохранение графа</li>
    <li>Ctrl+O - загрузка графа</li>
    <li>Delete - удаление выбранных элементов</li>
    <li>Space - пауза/продолжение анимации</li>
</ul>

<h3>Советы по использованию:</h3>
<ul>
    <li>Используйте разные алгоритмы размещения вершин для лучшей визуализации</li>
    <li>При работе с большими графами используйте пошаговое выполнение</li>
    <li>Следите за пояснениями для лучшего понимания работы алгоритма</li>
    <li>Используйте панель состояния переменных для отслеживания изменений</li>
</ul>
"""
